...
function ambilDaftarKataTersulit(maks = 15) {
  ...
  const daftar = Object.entries(semua)
    ...
    // "Lulus": begitu kata dijawab benar 5x, dianggap sudah dikuasai
    // dan otomatis lepas dari daftar latihan kata tersulit.
    .filter(x => x.salah > 0 && x.skorKesulitan > -3 && x.benar < 5)
